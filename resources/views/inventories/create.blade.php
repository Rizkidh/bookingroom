<x-app-layout>
            ...
            <form action="{{ route('inventories.store') }}" method="POST">
                ...
                <div class="stock-grid">
                    <div class="form-group stock-input-total">
                        ...
                        <input type="number" name="total_stock" id="total_stock" value="{{ old('total_stock', 0) }}" required
                            class="form-input @error('total_stock') input-error @enderror" min="0">
                    </div>

                    <div class="form-group stock-input-available">
                        <label for="available_stock" class="form-label">✅ Tersedia</label>
                        <input type="number" name="available_stock" id="available_stock" value="{{ old('available_stock', 0) }}" required
                            class="form-input @error('available_stock') input-error @enderror" min="0">
                    </div>

                    <div class="form-group stock-input-damaged">
                        <label for="damaged_stock" class="form-label">⚠️ Rusak</label>
                        <input type="number" name="damaged_stock" id="damaged_stock" value="{{ old('damaged_stock', 0) }}" required
                            class="form-input @error('damaged_stock') input-error @enderror" min="0">
                    </div>
                </div>
                <p class="form-helper">* Stok Tersedia + Rusak = Total Stok (otomatis tersinkronisasi)</p>
    ...
    <script>
        // Script sinkronisasi stok tetap sama seperti sebelumnya
