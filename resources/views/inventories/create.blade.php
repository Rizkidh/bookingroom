    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <h2 class="text-2xl font-semibold text-gray-800 mb-6">Tambah Item Inventaris Baru</h2>
                ...
                <form action="{{ route('inventories.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="total_stock" id="total_stock" value="{{ old('total_stock', 0) }}" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('total_stock') border-red-500 @enderror">
                    </div>

                    <div class="mb-4">
                        <label for="available_stock" class="block text-gray-700 text-sm font-bold mb-2">Stok Tersedia (Functional):</label>
                        <input type="number" name="available_stock" id="available_stock" value="{{ old('available_stock', 0) }}" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('available_stock') border-red-500 @enderror">
                    </div>

                    <div class="mb-6">
                        <label for="damaged_stock" class="block text-gray-700 text-sm font-bold mb-2">Stok Rusak (Damaged):</label>
                        <input type="number" name="damaged_stock" id="damaged_stock" value="{{ old('damaged_stock', 0) }}" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('damaged_stock') border-red-500 @enderror">
                    </div>
