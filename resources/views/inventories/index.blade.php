<x-app-layout>
    ...
    <div class="flex-1 flex flex-col min-h-0 overflow-hidden" data-auto-refresh="120">
        <div class="flex-1 flex flex-col bg-white rounded-xl shadow-sm border border-gray-100 min-h-0 overflow-hidden">
            ...
            <div class="p-3 sm:p-4 border-b border-gray-100 flex-shrink-0 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                ...
                <div class="flex gap-2 w-full sm:w-auto">
                    <a href="{{ route('inventories.export') }}" 
                       data-turbo="false"
                       class="btn-success flex-1 sm:flex-none px-3 sm:px-4 py-2 text-[10px] sm:text-xs flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700">
